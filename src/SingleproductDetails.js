        ...
        <div className="bg-white w-[70vw] h-[80vh] my-5 shadow-xl flex">
          <div className="basis-3/5  relative ">
            <AiOutlineHeart
              ...
              className={`${
                color
                  ? "absolute right-8 bg-white rounded-full p-1 pt-[6px] cursor-pointer foc text-[29px] mt-5 text-red-600"
                  : "absolute right-8 bg-white rounded-full p-1 pt-[6px] cursor-pointer foc text-[29px] mt-5"
              } `}
            />
            <div className="flex justify-center items-center  ">
          ...
          <div className="basis-2/5 bg-[#e4e4e4]">
            ...
            <div className="flex">
              <h2 className="text-[30px] font-bold pl-5 mt-2">
                {alldatas.name}
              </h2>
